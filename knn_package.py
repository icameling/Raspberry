...
class ContourWithData():
    ...
    def checkIfContourIsValid(self):                            # this is oversimplified, for a production grade program
        ...
        if (self.intRectHeight/self.intRectWidth < 1.0) or (self.intRectHeight/self.intRectWidth > 8.0): return False
        return True

class knn():

    file_list = []
    dir_path = ["E:\\opencv3\\python char recg\\pic1",
    ...
    dir_path2 = ["E:\\opencv3\\step3_more_imgs\\0",
